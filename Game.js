class Game {
  ...
  play() {
    ...
    player.getCarsAtEnd(); // Professora
  ...
  handleResetButton() {
    this.resetButton.mousePressed(() => {
      database.ref("/").set({
        ...
        gameState: 0,
        players: {},
        carsAtEnd: 0 // atribuir valor de zero para voltar pro iniio resetar o jogo
      });
      window.location.reload();
    });
  }
  // Aluno criar barra de progresso
  ...
  // aluno = POP_UP que pdoemos personalizar
  gameOver(){
    swal({
      title: `Fim de Jogo`,
